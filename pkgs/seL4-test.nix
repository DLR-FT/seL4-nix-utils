...
stdenv.mkDerivation rec {
  ...
  nativeBuildInputs = [
    ...
    # stdenvNoLibs.cc.cc
    # stdenvNoLibs.cc.bintools.bintools
    cmake # build tools
  ...
  env.NIX_CFLAGS_COMPILE = builtins.concatStringsSep " " ([ ]
    ...
    ++ lib.lists.optional (!hostPlatform.isx86) "-fpic"
    # ++ lib.lists.optional (stdenvNoCC.hostPlatform.isxRiscv) "-fpic"
  );
  ...
  ++ lib.lists.optional (hostPlatform.isAarch32) "-DAARCH32=1"
  ++ lib.lists.optional (hostPlatform.isAarch64) "-DAARCH64=1"
  ++ lib.lists.optional (hostPlatform.isRiscV64) "-DRISCV64=1"
  ++ lib.lists.optional (hostPlatform.isRiscV32) "-DRISCV32=1"
  ++ extraCmakeFlags;
