    ...
    flake-utils.lib.eachSystem [ "x86_64-linux" ] (
      ...
      in
      {
        packages = {
          ...
          /*
            Note: there used to be some stuff around Linux kernel hacking and tinkering. This
            investigation got widened and deepend, living along in it's own repo now:
